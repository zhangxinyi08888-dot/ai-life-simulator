...
export function createHistoryItemFromNode(node: SimulationNode, selectedChoice: string): HistoryItem {
  ...
  return {
    ...
    debtHealthState: cloneValue(node.debtHealthState),
    ...
    financialProcessingMeta: cloneValue(node.financialProcessingMeta),
...
export function restoreHistoryNodeAtIndex(history: HistoryItem[], targetIndex: number): RestoredHistoryNode {
  ...
  const node: SimulationNode = {
    ...
    debtHealthState: cloneValue(targetItem.debtHealthState),
    ...
    financialProcessingMeta: cloneValue(targetItem.financialProcessingMeta),
