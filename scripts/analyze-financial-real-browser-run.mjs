...
| 未分类核心支出估算 | ${summary.unclassifiedExpenseMonths} 人月 / ${summary.unclassifiedExpenseSnapshotCount} 节点；金额人月占比 ${displayPercent(summary.unclassifiedExpenseSharePct)} | 实际计提但不得冒充住房、医疗或家庭责任事实 |
| 已确认分类支出金额人月占比 | ${displayPercent(summary.knownTypedExpenseSharePct)} | 观察未分类估算是否随 Accepted 分类事实逐步收敛 |
